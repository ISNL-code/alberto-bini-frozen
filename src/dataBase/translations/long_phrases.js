export const LONG_PHRASES = {
  en: {
    before_ordering_enter_phone_number_or:
      "Before ordering, please enter your phone number or",
    ...
    call_back_messageB:
      "You can contact us in any messenger available or by phone.",
    ...
    manager_check_size:
      "When placing an order, please check with the manager for current size availability.",
  },
  fr: {
    before_ordering_enter_phone_number_or:
      "Avant de commander, veuillez entrer votre numéro de téléphone ou",
    ...
    call_back_messageC:
      "Merci de l`intérêt que vous portez à notre catalogue en ligne!",
    ...
    an_email_with_a_link_has_been_sent_to_your_email:
      "Un email avec un lien a été envoyé à votre email",
  ...
  es: {
    before_ordering_enter_phone_number_or:
      "Antes de ordenar, por favor ingrese su número de teléfono o",
    ...
    call_back_messageB:
      "Puedes contactarnos en cualquier messenger disponible o por teléfono.",
    ...
    user_with_this_email_not_found:
      "Usuario con este correo electrónico no encontrado",
    an_email_with_a_link_has_been_sent_to_your_email:
  ...
  ua: {
    ...
    call_back_messageB:
      "Ви можете зв’язатися з нами в будь-якому доступному месенджері або по телефону.",
    ...
    manager_check_size:
      "При оформленні замовлення запитуйте у менеджера актуальну наявність розмірів",
  },
  pl: {
    before_ordering_enter_phone_number_or:
      "Przed zamówieniem proszę podać swój numer telefonu lub",
    ...
    call_back_messageC:
      "Dziękujemy za zainteresowanie naszym katalogiem online!",
  ...
  cz: {
    before_ordering_enter_phone_number_or:
      "Před objednáním zadejte své telefonní číslo nebo",
    ...
    call_back_messageB:
      "Můžete nás kontaktovat v jakémkoli uvedeném messengeru nebo telefonicky.",
    ...
    an_email_with_a_link_has_been_sent_to_your_email:
      "Na váš e-mail byl odeslán e-mail s odkazem",
    wholesales_ordering_limitation_message:
  ...
  ru: {
    before_ordering_enter_phone_number_or:
      "Перед оформлением заказа введите номер телефона или",
    ...
    call_back_messageB:
      "Вы можете связаться с нами в любом доступном мессенджере или по телефону.",
    ...
    manager_check_size:
      "При оформлении заказа уточняйте у менеджера актуальное наличие размеров.",
  },
  kz: {
    before_ordering_enter_phone_number_or:
      "Тапсырыс бермес бұрын телефон нөміріңізді енгізіңіз немесе",
    registering: "Тіркелу",

    something_went_wrong:
      "Бір нәрсе дұрыс болмады, кейінірек қайталап көріңіз!",
    question_form_message:
    ...
    call_back_messageC:
      "Біздің онлайн каталогымызға қызығушылық танытқаныңыз үшін рахмет!",
    ...
    user_with_this_email_not_found:
      "Бұл электрондық поштамен пайдаланушы табылған жоқ",
    an_email_with_a_link_has_been_sent_to_your_email:
